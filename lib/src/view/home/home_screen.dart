        ...
        child: SingleChildScrollView(
          child: BlocConsumer<HomeBloc, HomeState>(
            ...
            listener: (context, state) {
              ...
              Messenger(context, state.msg, true);
            },
            builder: (context, state) {
              switch (state.runtimeType) {
                case HomeLoadingState:
                  {
                    state as HomeLoadingState;
                    return defaultIndicator(state.msg);
                  }
                        ...
                        BlocBuilder<HomeBloc, HomeState>(
                          ...
                          builder: (context, state) {
                            switch (state.runtimeType) {
                              ...
                              case HomeInitState || HomeSearchPlaceState:
                                {
                                  return Container(
                                    width: width,
                                    height: height * .43,
                                                                      ...
                                                                      children: [
                                                                        Text.rich(
                                                                          TextSpan(
                                                                            children: [
                                                                              TextSpan(
                                                                                text: '${state is HomeSearchPlaceState ? state.products[index]["name"] : state is HomeInitState ? state.products[index]["name"] : ""} ',
                                                                                style: TextStyle(
                                                                                  color: Colors.white,
                                                                                  fontSize: 16,
                                                                                  fontFamily: 'Roboto',
                                                                              ...
                                                                              TextSpan(
                                                                                text: '${state is HomeSearchPlaceState ? state.products[index]["location"].toString().separateFirstLocation() : state is HomeInitState ? state.products[index]["location"].toString().separateFirstLocation() : ""}',
                                                                                style: TextStyle(
